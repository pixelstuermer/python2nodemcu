...
You maybe have to restart the device manually.
But then You should be able to view the console output of the script via the already explained `screen` command.
...
[source,python]
----
include::samples/counter/main.py[]
----
