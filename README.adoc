...
The second code snippet needs some hardware, because only with sensors and actuators the IoT-suited microcontrollers become fun :rocket:!
...
After wiring it all together (as shown above), the code to blink the LED will look like this:
