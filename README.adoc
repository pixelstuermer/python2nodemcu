...
Download the latest https://github.com/scientifichackers/ampy/release[release], unzip it and once again run the following command:
...
Assuming You already have a Python script named `main.py`, this one does the trick:
